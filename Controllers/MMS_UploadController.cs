...
namespace ERP.Controllers
{
    ...
    [ApiController]
    public class MMS_UploadController : ControllerBase
    {
        private readonly IUnitofWork uow;
        private readonly UserManager<ApplicationUser> userManager;
        public static IWebHostEnvironment environment;
        public MMS_UploadController(IUnitofWork _uow, UserManager<ApplicationUser> _userManager, IWebHostEnvironment _environment)
        {
            uow = _uow;
        ...
        public ActionResult UploadLichSu(IFormFile file, string stringPath)
        {
            lock (Commons.LockObjectState)
            {
                ...
                string baseFileName = $"{dt.Month}_{dt.Year}";
                string fileExt = Path.GetExtension(file.FileName).ToLower();
                ...
                string baseApiUrl = Commons.ApiUrlMMS;
                // string baseApiUrl = "https://10.17.41.181/";
