...
namespace ERP.Controllers
{
    ...
    [ApiController]
    public class MMS_DM_LoaiController : ControllerBase
    {
        private readonly IUnitofWork uow;
        private readonly UserManager<ApplicationUser> userManager;
        public static IWebHostEnvironment environment;
        public MMS_DM_LoaiController(IUnitofWork _uow, UserManager<ApplicationUser> _userManager, IWebHostEnvironment _environment)
        {
            uow = _uow;
        ...
        public ActionResult Get(string keyword, int page = 1)
        {
            ...
            var data = uow.DM_Loais.GetAll(t => !t.IsDeleted
                ).Select(x => new
                {
                    x.Id,
                    x.Name
        ...
        public ActionResult GetTaiXe()
        {
            ...
            var data = uow.DM_Loais.GetAll(t => !t.IsDeleted, null, includes
                ).Select(x => new
                {
                    x.Id,
                    TenLoai = x.Name,
