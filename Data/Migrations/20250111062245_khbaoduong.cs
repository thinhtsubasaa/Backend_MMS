...
{
    /// <inheritdoc />
    public partial class khbaoduong : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "KeHoachBaoDuongs",
                columns: table => new
                {
                    ...
                    IsQuaHan = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KeHoachBaoDuongs", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_KeHoachBaoDuongs_DS_PhuongTiens_PhuongTien_Id",
                        column: x => x.PhuongTien_Id,
                        principalTable: "DS_PhuongTiens",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_KeHoachBaoDuongs_DS_ThietBis_ThietBi_Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KeHoachBaoDuongs_BaoDuong_Id",
                table: "KeHoachBaoDuongs",
                column: "BaoDuong_Id");

            migrationBuilder.CreateIndex(
                name: "IX_KeHoachBaoDuongs_PhuongTien_Id",
                table: "KeHoachBaoDuongs",
                column: "PhuongTien_Id");

            migrationBuilder.CreateIndex(
                name: "IX_KeHoachBaoDuongs_ThietBi_Id",
                table: "KeHoachBaoDuongs",
                column: "ThietBi_Id");
        }
